...
_Proof._ Use that $v_K^+(t) = p_K(t)u_t + \partial^+p_K(t)v_t$ is locally of [[#^thm-vertex-bounded-variation|bounded variation]] and that $p_K$ is [[#^thm-support-function-lipschitz|Lipschitz]]. □
