...
_Proof._ (sketch) The $x$ and $y$-coordinates of $v_K^+(t)$ either monotonically increases or decreases on each of the intervals $[0, \pi/2]$, $[\pi/2, \pi]$, $[\pi, 3\pi/2]$, $[3\pi/2, 2\pi]$ by [[01. Convex Bodies#^thm-vertex-monotone]]. □
