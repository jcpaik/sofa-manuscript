...
_Proof._ By [[04. Boundary of Convex Bodies#^cor-boundary-segment-parametrization]], the curve $\mathbf{x}_{K, 0, 2 \pi}$ is an arc-length parametrization of $\partial K$. 
- Why is it Jordan? the curve be injective
