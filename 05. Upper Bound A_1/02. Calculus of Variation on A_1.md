...
By applying [[03. Area#^thm-variation-area]] to the first term and applying [[01. Green's Theorem#^thm-variation-curve]] to the second term, we reach the following.
$$
...
and this is exactly [[03. Differential Geometry on Monotone Sofas#^thm-inner-corner-deriv]].
$$
...
$$
We get the original equation by plugging this back to the equation [[#^434798]] for $\left. \frac{d}{d\lambda} \right|_{\lambda = 0} \mathcal{A}_1(K)$. □
