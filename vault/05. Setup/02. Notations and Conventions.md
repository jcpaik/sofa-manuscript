...
A _shape_ is a nonempty compact subset of $\mathbb{R}^2$. Denote the area (Borel measure) of a shape $X$ as $|X|$. We define tangent lines and corresponding half-planes of an arbitrary shape $S \subset \mathbb{R}^2$ as the following.
