...
We now state the _injectivity condition_ of a monotone sofa.
...
In particular, Gerver's sofa $S_G$ is a monotone sofa satisfying the injectivity condition. For monotone sofas satisfying the injectivity condition, the following upper bound is established.
