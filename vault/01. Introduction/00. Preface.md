...
Gerver pushed his idea further and showed the followings for a maximum-area sofa $S$ as well.
...
[[10. Notations and conventions/00. Preface]] 
...
[[A1. Convex bodies/00. Preface]] proves numerous properties of an arbitrary planar convex body $K$ that we will use in this paper. So the logical ordering of this paper is [[10. Notations and conventions/00. Preface]], followed by [[A1. Convex bodies/00. Preface]], then the rest starting [[15. Monotone sofas/00. Preface]]. A logically inclined reader may follow this ordering. Readers who are interested in the overall idea, on the other hand, may read the sections in order and refer to the appendix when needed.
