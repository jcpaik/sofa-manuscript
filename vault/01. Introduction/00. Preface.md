...
Another key idea of the proof of [[01. Introduction/00. Preface#^thm-main]] is to identify a monotone sofa $S$ by its convex hull $K$, that we will call the _cap_ of $S$.
