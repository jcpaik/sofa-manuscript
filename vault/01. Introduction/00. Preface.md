...
Another key idea of the proof of [[01. Introduction/00. Preface#^thm-main]] is to identify a monotone sofa $S$ by its convex hull $K$. The overestimated area $\mathcal{A}_1$, as a function of the convex body $K$, turns out to be a _concave quadratic functional_ with respect to $K$. 
