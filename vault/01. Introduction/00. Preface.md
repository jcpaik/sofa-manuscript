...
> __Theorem [monotone-sofa].__ (Gerver) There exists a monotone sofa $S_{\max}$ with rotation angle $\omega \in (\pi/3, \pi/2]$ attaining the maximum area $\mu_{max}$. ^thm-monotone-sofa
