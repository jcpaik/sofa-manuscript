...
[^gerver-derivation]: In [[@gerverMovingSofaCorner1992]], Gerver had to assume five specific stages of sofa movement to derive his sofa $S_G$. Romik's derivation of Gerver's sofa $S_G$ in [[@romikDifferentialEquationsExact2018]] also relies on this assumption, so their derivations do not constitute a full proof of Gerver's conjecture $\mu_{\max} = \mu_G$.
