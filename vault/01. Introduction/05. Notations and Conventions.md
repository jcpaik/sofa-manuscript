...
The notion of _width_ along a direction (e.g. p49 of [[@schneider_2013]])
...
We follow p8 of [[@schneider_2013]] for this definition. Many authors often also include the condition that $K^\circ$ is nonempty, but in our definition we allow $K^\circ$ to be empty (e.g. line segment or point).
