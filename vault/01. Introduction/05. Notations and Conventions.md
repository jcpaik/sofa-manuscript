...
The support function $p_S(t)$ measures the signed distance from the origin to the tangent line $l_S(t)$ of $S$ with normal vector $u_t$ directing outwards from $S$.
