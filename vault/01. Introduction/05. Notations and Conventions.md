...
Observe that the width of $S$ along $u_t$ measures the distance between the parallel tangent lines $l_S(t)$ and $l_S(t + \pi)$.
...
So the boundary of tangent half-plane $H_S(t)$ is $l_S(t)$. Now we move on to convex bodies.
