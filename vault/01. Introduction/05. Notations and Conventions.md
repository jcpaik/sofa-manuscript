A _proposition_ is a small statement whose truth follows from discussion. A _corollary_ is a consequence directly followed by a theorem. Each subsection comes with an overview. It suffices to understand the overview to move to the next subsection.
