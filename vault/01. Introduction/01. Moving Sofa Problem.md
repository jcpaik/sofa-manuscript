...
[[A1. Convex bodies/00. Preface]] proves numerous properties on a general planar convex body $K$ that we will need in this paper. Logical precedence of this paper is in the order of [[01. Introduction/05. Notations and conventions]], [[A1. Convex bodies/00. Preface]], and then the rest of the papers starting [[15. Monotone sofas/00. Preface]]. However, since the contents of [[A1. Convex bodies/00. Preface]] are rudimentary and not the main focus of this paper, it is recommended to read the paper from beginning and refer to the appendix only when needed.
