...
> __Remark [angle].__ A single moving sofa $S$ may admit different movements in $L$ with varying rotation angle $\omega$. In this paper, we will always assume that a moving sofa $S$ is always . So whenever  ^rem-angle
