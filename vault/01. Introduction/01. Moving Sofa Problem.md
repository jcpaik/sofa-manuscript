...
2. A translation of $R_\omega(V)$, the vertical strip $V = [0, 1] \times \mathbb{R}$ rotated counterclockwise by $\omega$. Observe that at the end of the movement, $S$ is contained in the vertical side $L_V$ rotated clockwise by $\omega$.
