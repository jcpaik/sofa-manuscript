...
We prove in [[a. Angle Hypothesis/05. Monotone Sofa/00. Preface]] that any maximum-area moving sofa $S = S_{\max}$ satisfies the following properties, establishing $S = \mathcal{I}$ in particular.
