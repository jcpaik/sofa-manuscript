...
The proof of [[a. Angle Hypothesis/10. Balanced Sofas/01. Nef Polygons#^thm-nef-polygon-area-diff]] will be done by proving smaller cases and building up on it.
...
The following [[a. Angle Hypothesis/10. Balanced Sofas/01. Nef Polygons#^lem-nef-polygon-single-edge]] is a special case of [[a. Angle Hypothesis/10. Balanced Sofas/01. Nef Polygons#^thm-nef-polygon-area-diff]] where we set $\delta_i = 0$ for all index $i$ except for $i=j$.
...
From the contribution analysis above, we obtain that the difference between $A$ and $B$ is at most $|S_{\geq 2}|$. Use this and apply [[a. Angle Hypothesis/10. Balanced Sofas/01. Nef Polygons#^lem-nef-polygon-single-edge]] to each $|P_j'|$ to get 
$$
