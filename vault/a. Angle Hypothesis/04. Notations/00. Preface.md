We define the standard notions on a planar shapes and convex bodies (e.g. [[@schneider_2013]]). Here, $S^1$ is taken as $\mathbb{R} / 2\pi \mathbb{Z}$. We will often represent an element of $S^1$ by its representation in $\mathbb{R}$.
