...
> __Definition [hausdorff-distance].__ Define the _Hausdorff distance_ $d_h$ of convex bodies $K_1$ and $K_2$ as the supremum norm between $h_{K_1}$ and $h_{K_2}$. ^def-hausdorff-distance
