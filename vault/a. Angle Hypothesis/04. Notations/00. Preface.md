...
- Let $K$ be any convex body in $\mathbb{R}^2$. Denote the _surface area measure_ of $K$ on $S^1$ as $\sigma_K$. For any $t \in S^1$, denote $\sigma_K\left( \left\{ t \right\} \right)$ as simply $\sigma_K(t)$.
- Let $K$ be any convex body in $\mathbb{R}^2$. Define the normal angle $\mathbf{n}(K)$ of $K$ as the support of $\sigma_K$.
- Theorem. Intersection of supporting planes with normal angles.