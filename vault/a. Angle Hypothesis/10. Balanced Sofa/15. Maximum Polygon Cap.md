...
> 2. For any $t \in \left\{ \omega, \pi/2 \right\}$ we have $\nu_K(t) + \lambda^1\left( \partial \mathcal{N}(K) \cap l(t, 0) \right) = \sigma_K(t + \pi)$.

_Proof._ Compare the boundary of $\mathcal{N}_\Theta(K)$ and 

(1) By [[a. Angle Hypothesis/10. Balanced Sofa/15. Maximum Polygon Cap#^thm-polyline]],  □
