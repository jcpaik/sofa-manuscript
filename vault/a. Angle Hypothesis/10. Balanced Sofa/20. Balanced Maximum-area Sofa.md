...
> __Theorem [limiting-maximum-sofa].__ A balanced maximum cap $K_\omega$ is the cap of the monotone sofa $S_\omega := K_\omega \setminus \mathcal{N}(K_\omega)$, attaining the maximum area among all moving sofas of rotation angle $\omega$. ^thm-limiting-maximum-sofa
