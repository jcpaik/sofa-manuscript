We will prove the following [[a. Angle Hypothesis/15. Proof of the Angle Hypothesis/00. Preface#^thm-balanced-consumed]].
...
TODO: Doesn't work! Need to bump the lower bound of $d$ up when $\omega$ gets much lower than $\pi/2$. Also make sure the calculations are precise.
