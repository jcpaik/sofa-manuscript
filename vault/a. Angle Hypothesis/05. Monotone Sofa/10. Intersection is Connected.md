...
That $S'$ contains $S$ comes from [[a. Angle Hypothesis/05. Monotone Sofa/10. Intersection is Connected#^pro-monotonization-contains-sofa]]. That $S'$ is in standard position comes from $S \subseteq S' \subseteq H \cap V_\omega$. □