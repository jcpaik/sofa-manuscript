...
We now show that for any monotone sofa $S$, its cap $K$ contains the niche $\mathcal{N}(K)$ ([[a. Angle Hypothesis/05. Monotone Sofa/15. Structure of a Monotone Sofa#^thm-niche-in-cap]]).
...
We identify the exact condition where $\mathcal{N}(K) \subseteq K$ for a general cap $K$ following [[12. Cap and Niche#^def-cap]].
