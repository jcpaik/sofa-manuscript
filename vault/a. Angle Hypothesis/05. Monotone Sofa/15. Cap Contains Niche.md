...
We identify the exact condition where $\mathcal{N}(K) \subseteq K$ for a general cap $K$ following [[a. Angle Hypothesis/05. Monotone Sofa/12. Cap and Niche#^def-cap]].
