Here, we show that any monotone sofa $S$ is equal to its _cap_ $K$ ([[a. Angle Hypothesis/05. Monotone Sofa/12. Cap and Niche#^thm-cap-hallway-intersection]]) minus _niche_ $\mathcal{N}(K)$ ([[a. Angle Hypothesis/05. Monotone Sofa/12. Cap and Niche#^def-niche]]). We first define the notion of _cap_ as a kind of convex body.
...
> 2. $K$ is an intersection of closed half-planes $H_K(t)$ with normal angles $t \in J_\omega \cup \{\pi + \omega, 3\pi/2\}$ (where $J_\omega$ is from [[a. Angle Hypothesis/05. Monotone Sofa/10. Monotone Sofa#^def-set-j]]).
...
By [[a. Angle Hypothesis/05. Monotone Sofa/12. Cap and Niche#^thm-monotonization-fixpoint]], the map $S \mapsto \mathcal{I}(S)$ is a 'projection' from all moving sofas to monotone sofas in the sense that $\mathcal{I}$ is a surjective map that fixes monotone sofas. 

The definition of a monotone sofa $S = \mathcal{I}(S')$ depends on another moving sofa $S'$ ([[a. Angle Hypothesis/05. Monotone Sofa/10. Monotone Sofa#^thm-monotonization]]). The following [[a. Angle Hypothesis/05. Monotone Sofa/12. Cap and Niche#^thm-monotone-sofa-structure]] describes the structure of $S$ without relying on 
