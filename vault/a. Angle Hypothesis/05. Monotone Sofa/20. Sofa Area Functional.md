...
We will change the moving sofa problem to the maximization of $\mathcal{A}_\omega$. But recall that as in [[a. Angle Hypothesis/05. Monotone Sofa/15. Structure of a Monotone Sofa#^rem-niche-not-in-cap]], not all cap $K \in \mathcal{K}_\omega$ is the cap $\mathcal{C}(S)$ of a monotone sofa $S$. So it is not at all obvious that the maximizer $K_\omega$ of $\mathcal{A}_\omega$ may not correspond to a monotone sofa $S_\omega$. This will be established at the end of the next [[a. Angle Hypothesis/10. Balanced Sofa/00. Preface]] (). 