Following the outline in [[a. Angle Hypothesis/03. Outline/07. Proof of the Main Theorem]], we will prove [[a. Angle Hypothesis/15. Proof of the Main Theorem/00. Preface#^thm-balanced-consumed]] which will immediately imply the main [[a. Angle Hypothesis/01. Introduction/00. Preface#^thm-angle]].

We factor out technical calculations of the proof. While the definitions and lemmas are stated in logical order, we encourage the reader to jump to [[a. Angle Hypothesis/15. Proof of the Main Theorem/00. Preface#^thm-balanced-consumed]] right away and refer back to them only when needed. The outline in [[a. Angle Hypothesis/03. Outline/07. Proof of the Main Theorem]] and Figure XX should help in navigating the proof of [[a. Angle Hypothesis/15. Proof of the Main Theorem/00. Preface#^thm-balanced-consumed]].
