...
Take any mo sofa $S$ of area $> 2.2$.

Let $S_{\pi/2}$ be the monotone sofa in XX attaining the maximum area conditioned to rotation angle $\pi/2$.  have area at most that of $S_{\pi/2}$. Since Gerver's sofa $S_G$ have rotation angle $\pi/2$ and area $2.2$, we have $2.2$

By [[a. Angle Hypothesis/03. Overview/07. Proof of the Main Theorem#^lem-rotation-angle-simple-bound]], $S$ 
