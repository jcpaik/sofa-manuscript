Following the outline in [[a. Angle Hypothesis/03. Outline/07. Proof of the Main Theorem]], we will prove [[a. Angle Hypothesis/15. Proof of the Main Theorem/00. Preface#^thm-balanced-consumed]] which will immediately imply the main [[a. Angle Hypothesis/01. Introduction/00. Preface#^thm-angle]]. We factor out technical calculations, and encourage the reader to jump to [[a. Angle Hypothesis/15. Proof of the Main Theorem/00. Preface#^thm-balanced-consumed]] right away and refer back to them only when needed. The outline in [[a. Angle Hypothesis/03. Outline/07. Proof of the Main Theorem]] and [[a. Angle Hypothesis/15. Proof of the Main Theorem/00. Preface#^fig-balanced-consumed]] should help navigating the proof.
...
> __Figure [balanced-consumed].__ Definitions in the proof of [[a. Angle Hypothesis/15. Proof of the Main Theorem/00. Preface#^thm-balanced-consumed]]. ^fig-balanced-consumed
> 
...
_Proof._ (of [[a. Angle Hypothesis/01. Introduction/00. Preface#^thm-angle]]) For every $\omega \in (0, \pi/2]$, use [[a. Angle Hypothesis/10. Balanced Sofa/20. Balanced Maximum-area Sofa#^thm-limiting-maximum-sofa]] to find a monotone sofa $S_\omega$ of maximum area with rotation angle $\omega$ and limiting maximum cap $K_\omega$. It suffices to show $|S_\omega| \leq |S_{\pi/2}|$ for all $\omega$. By [[a. Angle Hypothesis/03. Outline/07. Proof of the Main Theorem#^lem-rotation-angle-simple-bound]] we can assume $\omega > \sec^{-1}(2.2)$. By [[a. Angle Hypothesis/15. Proof of the Main Theorem/00. Preface#^thm-balanced-consumed]], the triangle $\Delta_\omega$ formed by $O, o_\omega - v_0, o_\omega - u_\omega$ is contained in $\mathcal{N}(K_\omega)$, so is disjoint from $S_\omega$. Now $S_\omega$ can rotate counterclockwise by $\pi/2 - \omega$ in $H$. Combine this with the clockwise movement of $S_\omega$ in $L$ to have $|S_\omega| \leq |S_{\pi/2}|$. □
