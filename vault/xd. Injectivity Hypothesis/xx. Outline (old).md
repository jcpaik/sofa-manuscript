> __Theorem [injective].__ There exists a moving sofa $S$ of maximum area with rotation angle $\pi/2$ and injective inner corner $\mathbf{x}_S : [0, \pi/2] \to \mathbb{R}^2$. ^thm-injective
