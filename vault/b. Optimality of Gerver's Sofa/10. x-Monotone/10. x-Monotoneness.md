This is an extension of [[a. Angle Hypothesis/10. Balanced Sofa/00. Preface|00. Preface]]. Recall in particular that 
...
_Proof._ $\Theta$ is the set of dyadic angles in $(0, \pi/2)$. For any $a, b \in \Theta \cup \left\{ \pi/2 \right\}$, take the interval $(a, b]$. $na, n b$ are integers. $\sigma_K$ on that interval can be divided into smaller chunks. Supress that with [[b. Optimality of Gerver's Sofa/10. x-Monotone/10. x-Monotoneness#^lem-balanced-discrete-ineq]].
...
We bootstrap [[b. Optimality of Gerver's Sofa/10. x-Monotone/10. x-Monotoneness#^thm-leg-length-bounds]] multiple times.
...
1. By (1) and (2) of [[b. Optimality of Gerver's Sofa/10. x-Monotone/10. x-Monotoneness#^pro-lower-bound-constants]] we have values from $1+T$ to 2.
