...
_Proof._ Conditions (1) to (4) in [[b. Optimality of Gerver's Sofa/15. Upper Bound Q/05. Definition of A2 and Q#^def-extended-cap-space]] are linear equalities and inequalities on $K$, $\mathbf{b}$ and $\mathbf{d}$. □
