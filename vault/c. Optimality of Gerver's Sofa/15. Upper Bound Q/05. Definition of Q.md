...
_Proof._ Conditions (1) to (4) in [[c. Optimality of Gerver's Sofa/15. Upper Bound Q/05. Definition of Q#^def-extended-cap-space]] are linear equalities and inequalities on $K$, $\mathbf{b}$ and $\mathbf{d}$. □
