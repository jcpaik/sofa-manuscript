...
Note that $v_K(t, t')$ was defined as the intersection of $l_K(t)$ and $l_K(t')$. So $\tau_K(t, t')$ fixes the line at angle $t'$ and measures the distance along the line at angle $t$. Note that in [[05. Vertex and support function#^def-tangent-leg-length]], such a value $\alpha$ exists because the points $v_K(t, t')$ and $v_K^+(t)$ are on the line $l_K(t)$.
