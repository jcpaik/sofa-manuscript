...
We will soon show that the vertices $v_K^{\pm}(t)$ are also linear with respect to $K$. To do so, we compute the limit of vertices as in [[05. Vertex and support function#^lem-limits-converging-to-vertex]].
