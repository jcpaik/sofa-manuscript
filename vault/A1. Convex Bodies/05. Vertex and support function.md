...
> 2. $\mathbf{p}(t') = v_K^+(t') + \alpha(t') v_t$ where $\alpha(t) = 0$ and the function $\alpha$ is monotonically increasing.
...
A very similar argument proves the following variant [[05. Vertex and support function#^thm-tangent-line-parametrization]] of [[05. Vertex and support function#^thm-tangent-line-parametrization]]. We omit the proof.
...
> 2. $\mathbf{q}(t') = v_K^-(t') + \beta(t') v_t$ where $\beta(t) = 0$ and the function $\beta$ is monotonically increasing.
