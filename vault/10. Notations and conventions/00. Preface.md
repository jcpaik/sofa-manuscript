In this section, we set up basic notations, definitions and conventions that will be assumed thoroughout the rest of the document. We also gather the notions that will be defined later for easier reference. This section is not meant to be read in one setting. Instead, the reader can start by reading only the definitions related to moving sofas, shapes, and convex bodies and move on, and later refer to parts of this section as needed. Definitions not listed in this section will be always referenced before its first use in a proof.
