...
_Tangent hallway_ $L_S(t)$ of a shape $S$ will be defined in [[15. Monotone sofas/07. Tangent Hallway#^def-tangent-hallway]]. The parts $\mathbf{x}_S(t), \mathbf{y}_S(t), a_S(t), b_S(t), c_S(t), d_S(t), Q^+_S(t), Q^-_S(t)$ of the tangent hallway will be defined in [[15. Monotone sofas/07. Tangent Hallway#^def-rotating-hallway-parts]].
