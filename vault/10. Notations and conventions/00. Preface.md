...
This section is not meant to be read in one setting. Instead, the reader may start by reading only the definitions related to moving sofas, shapes, and convex bodies and move on, and later refer to parts of this section as needed.
