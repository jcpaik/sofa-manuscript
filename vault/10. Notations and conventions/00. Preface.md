...
The integral in [[10. Notations and conventions/00. Preface#^def-curve-area-functional]] is the Riemann-Stieltjes integral, for which we again refer to [@steinRealAnalysisMeasure2005]. Note that the value of $\mathcal{I}(\mathbf{x})$ is the same even if we take a re-. In particular, the 
