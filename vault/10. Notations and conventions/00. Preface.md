...
Refer to [[@steinRealAnalysisMeasure2005]] for the standard notion of bounded variation and absolute continuity of a single-variable, real-valued function. A continuous curve $\mathbf{x} : [a, b] \to \mathbb{R}^2$.  
