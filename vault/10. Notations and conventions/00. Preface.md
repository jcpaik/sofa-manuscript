...
For reference, the notion of _standard position_ will be defined in [[15. Monotone sofas/07. Tangent Hallway#^def-standard-position]]. The notion of _monotonization_ $\mathcal{M}(S)$, _cap_ $\mathcal{C}(S)$, and _niche_ $\mathcal{N}(K)$ will be defined in [[15. Monotone sofas/10. Monotonization#^def-monotonization]], [[15. Monotone sofas/10. Monotonization#^def-cap-sofa]], and [[15. Monotone sofas/12. Structure of a monotone sofa#^def-niche]] respectively.
