...
The following _directional derivative_ of a quadratic functional $f$ on a convex space $\mathcal{K}$ is the key to calculus of variation.
...
\end{split}
$$
by bilinearity of $h$. Now take derivative at $\lambda = 0$. □
