...
We now calculate the derivative of $\mathcal{I}(\mathbf{x}_K)$ with respect to $K$. We have the following general calculation the curve area functional $\mathcal{I}(\mathbf{x})$ of any curve $\mathbf{x}$.
