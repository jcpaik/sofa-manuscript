...
\end{align*}
$$
Define $R := o_\omega \cdot \int_{0}^{\omega} u_t (\omega - t)\, dt$. By multiplying by 2 we have the following.
$$
\begin{align*}
|K| & = 1 + \omega^3 / 3 + R
\end{align*}
...
$$
by [[15. Monotone sofas/07. Tangent Hallway#^pro-rotating-hallway-parts]]. We have $g_K(t) = 1 + t$ and $h_K(t) = 1 + \omega - t$ for all $t \in (0, \omega)$ by the proof of [[25. Upper bound A1/20. Maximizer of A1#^thm-maximum-presofa-a1]]. So
$$
