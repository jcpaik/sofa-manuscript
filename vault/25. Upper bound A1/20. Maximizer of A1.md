...
$$
by [[15. Monotone sofas/07. Tangent Hallway#^pro-rotating-hallway-parts]]. We also have
$$
\mathbf{x}'_{K}(t) = -(g_{K}^+(t) - 1) \cdot u_t + (h_{K}^+(t) - 1) \cdot v_t = 
- t \cdot u_t + (\omega - t) \cdot v_t.
$$
by [[25. Upper bound A1/01. Definition of A1#^thm-inner-corner-deriv]] and [[25. Upper bound A1/20. Maximizer of A1#^cor-maximum-presofa-a1-arm-length]].
$$
\begin{align*}
