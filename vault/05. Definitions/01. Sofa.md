...
We will only consider sofas of rotation angle $\omega \in [\pi/4, \pi/2]$. Indeed, Gerver has shown that a sofa of maximum area have rotation angle $\omega \in [\pi/3, \pi/2]$, and Romik and Kallus refined the result further to $\omega \in [\sin^{-1} (84/85), \pi/2]$ where the value is approximately $81.203\dots^\circ$. Here we provide a self-contained proof that we can assume $\omega \in [\pi/4, \pi/2]$.
