...
Note that although we typically say that the image $\Gamma$ of parametrization $\alpha$ is a curve, the curve is actually the datum $(\Gamma, \alpha)$ of both the image $\Gamma$ and its parametrization $\alpha$.
