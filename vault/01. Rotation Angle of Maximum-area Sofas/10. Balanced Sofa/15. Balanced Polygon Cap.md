...
> __Theorem [balanced-polygon-sofa-connected].__ Any maximum polygon cap $K$ with angle set $\Theta$ contains its polygon niche $\mathcal{N}_\Theta(K)$. ^thm-balanced-polygon-sofa-connected
