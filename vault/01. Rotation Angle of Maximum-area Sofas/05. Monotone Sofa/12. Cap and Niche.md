...
_Proof._ Let $S = \mathcal{I}(S_0)$ for some moving sofa $S_0$ in standard position. By [[01. Rotation Angle of Maximum-area Sofas/05. Monotone Sofa/12. Cap and Niche#^pro-monotonization-cap]], the cap $K$ of $S$ is also the cap $\mathcal{C}(S_0)$ of $S_0$. So by [[01. Rotation Angle of Maximum-area Sofas/05. Monotone Sofa/12. Cap and Niche#^thm-monotonization-structure]] we have $S = \mathcal{I}(S_0) = K \setminus \mathcal{N}(K)$. □
