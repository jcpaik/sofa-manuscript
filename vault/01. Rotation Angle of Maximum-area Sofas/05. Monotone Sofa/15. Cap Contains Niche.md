...
> __Theorem [niche-in-cap].__ Let $K \in \mathcal{K}_\omega^\mathrm{c}$ be any cap with rotation angle $\omega \in (0, \pi/2]$. Then $K$ is the cap of a monotone sofa if and only if $\mathcal{N}(K)$ contains $K$. ^thm-niche-in-cap
