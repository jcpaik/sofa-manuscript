...
Geometrically, $M_\omega$ is a subset of $P_\omega$ enclosed by the perpendicular legs from $o_\omega$ to the bottom sides of $P_\omega$. We also introduce the following terminologies.
