...
We prepare the following corollary of [[10. Monotonization#^lem-cap-same-support-function]] to prove [[12. Structure of a monotone sofa#^thm-monotonization-structure]].
...
We end this subsection by proving [[12. Structure of a monotone sofa#^thm-cap-hallway-intersection]] as promised. Define the following subset of $P_\omega$.
