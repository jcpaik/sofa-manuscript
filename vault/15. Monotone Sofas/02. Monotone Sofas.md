...
So far, $K$ is the cap of the original sofa $S$, not its monotonization $\mathcal{M}(S)$. We will show that $K$ is also the cap of $\mathcal{M}(S)$ at the very end of this subsection.
...
- The case where $(0, 0)$ lies strictly below $b_T$ but does not lie strictly below $d_T$ can be handed similarly as above.
