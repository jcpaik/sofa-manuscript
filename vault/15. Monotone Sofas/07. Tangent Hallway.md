...
[^parallelogram]: If $\omega = \pi/2$, then the set $P_{\pi/2}$ is technically not a parallelogram. We will however call it as the parallelogram with rotation angle $\pi/2$ with a slight abuse of notation.