...
> 2. For every $t \in [0, \omega]$, $S$ is contained in a translation of $R_t(L)$, the hallway rotated counterclockwise by an angle of $t$. Moreover, $S$ is contained in a translation of $H$ and $R_\omega(V)$.
