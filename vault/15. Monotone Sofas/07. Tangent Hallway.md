Following the ideas of Gerver, we rigorously show that any moving sofa $S$ is a connected subset of the intersection of two strips and rotations of hallway ([[07. Tangent Hallway#^thm-moving-sofa-iff-hallway-intersection]]). We will also show that the rotated hallways containing $S$ can be assumed to be the _tangent hallways_ of $S$ ([[07. Tangent Hallway#^pro-tangent-hallway]]) making contact with $S$ in the outer walls.
...
Gerver's idea for proving [[07. Tangent hallway#^thm-moving-sofa-iff-hallway-intersection]] was to use the _tangent hallway_ of $S$ as the following.
...
With [[07. Tangent Hallway#^pro-tangent-hallway-contains]], we will always use the tangent hallways $L_S(t)$ as the rotated hallways containing our sofa $S$. We give names to the parts of $L_S(t)$ that will be used thoroughly. We first name the parts of the hallway $L$, then we name the parts of tangent hallway $L_S(t)$ accordingly.
