...
Following the ideas of Gerver, we show rigorously that any moving sofa $S$ is a connected subset of the intersection of two strips with width 1 and rotations of hallway ([[07. Moving Hallway Problem#^thm-moving-sofa-iff-hallway-intersection]]). We will also show that the rotated hallways containing $S$ can be assumed to be the _tangent hallways_ of $S$ ([[07. Moving Hallway Problem#^pro-tangent-hallway]]) making contact with $S$ in the outer walls.
