...
In particular, we can always assume that a sofa of maximum area is a monotone sofa by [[15. Monotone sofas/10. Monotonization#^thm-monotonization-is-sofa]]. proving [[01. Introduction/00. Preface#^thm-monotone-sofa]] in the introduction. The rest of this subsection is dedicated to proving [[10. Monotonization#^thm-monotonization-is-connected]].
