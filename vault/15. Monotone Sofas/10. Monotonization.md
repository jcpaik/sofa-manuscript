...
The second consequence of [[10. Monotonization#^lem-cap-same-support-function]] is that a moving sofa and its monotonization shares the same $\mathcal{C}(-)$.
...
_Proof._ The support functions of $S$ and $\mathcal{M}(S)$ match on $[0, \omega] \cup [\pi/2, \pi/2 + \omega]$ by [[15. Monotone sofas/10. Monotonization#^lem-cap-same-support-function]].  □
