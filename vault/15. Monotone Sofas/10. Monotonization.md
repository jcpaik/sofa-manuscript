...
Every monotonization of a moving sofa have the following structure consisting of a cap and a niche (we will give the full definitions of them later). This structure will be used thoroughout the rest of the paper including the proof of [[10. Monotonization#^thm-monotonization-is-connected]].
