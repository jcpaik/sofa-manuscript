...
Now the following comes from condition 3 of [[07. Tangent Hallway#^thm-moving-sofa-iff-hallway-intersection]] and that $\mathcal{M}(S)$ is connected.
...
So we can safely assume that a sofa of maximum area is a monotone sofa.
