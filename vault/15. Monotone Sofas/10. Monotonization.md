...
_Proof._ The support functions of $S$ and $K$ match on $[0, \omega] \cup [\pi/2, \pi/2 + \omega]$ by [[15. Monotone sofas/10. Monotonization#^lem-cap-same-support-function]]. The tangent hallways depend solely on the values of support function on $[0, \omega] \cup [\pi/2, \pi/2 + \omega]$ by [[15. Monotone sofas/07. Tangent Hallway#^def-tangent-hallway]]. □
