...
With [[07. Tangent Hallway#^pro-cap-hallway-intersection]], we can call $\mathcal{C}(S)$ the _cap_ of $S$. We omit the proof of [[07. Tangent Hallway#^pro-cap-hallway-intersection]]. The tangent hallways of a moving sofa $S$ are exactly same as the tangent hallways of its cap $K = \mathcal{C}(S)$.
