...
A _convex body_ $K$ is a nonempty, compact, and convex subset of $\mathbb{R}^2$ [^We follow p8 of Schneider for this definition. Note that other authors often also include the condition that $K^\circ$ is nonempty.].
