...
> __Proposition [upper-boundary-param].__ The upper boundary $\delta K$ has an arc-length parametrization $\mathbf{b}_K^{0-, \pi/2 + \omega}$ ([[15. Parametrization of boundary#^def-closed-param]]) from $A_K^-(0)$ to $C_K^+(\omega)$ in the counterclockwise direction. ^pro-upper-boundary-param
