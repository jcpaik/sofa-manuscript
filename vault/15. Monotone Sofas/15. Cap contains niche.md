...
With [[15. Cap contains niche#^thm-niche-in-cap]], the area $|S| = |K| - |\mathcal{N}(K)|$ of a monotone sofa can be understood separately in terms of the cap and the niche. The main difficulty of understanding the area is now concentrated at the niche $\mathcal{N}(K)$. Define the collection of all caps with a fixed angle set as follows.
...
Define the _sofa area functional_ $\mathcal{A}(K)$ on the space of caps $\mathcal{K}_\Theta$ or $\mathcal{K}_\omega$ as the 
...
# Proof of [[15. Cap contains niche#^thm-niche-in-cap]]

We now prove [[15. Cap contains niche#^thm-niche-in-cap]] as promised. We need a handful of geometric definitions. Define the _vertices_ of a cap $K$.
