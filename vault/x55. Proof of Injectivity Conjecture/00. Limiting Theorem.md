Theorem 1 of [[@gerverMovingSofaCorner1992]] shows that we have a sequence of _balanced polygons_ converging to a certain sofa of maximum area. Analogously, Gerver constructs a sequence of 
In this section, we 
