...
Once the connectedness of $\mathcal{M}(S)$ is established, we can immediately show that the monotonization $\mathcal{M}(S)$ is a moving sofa larger than or equal to the initial moving sofa $S$.
