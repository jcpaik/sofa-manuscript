...
Compare the equation in [[15. Monotone sofas/10. Monotonization#^def-monotonization]] to [[01. Introduction/02. Moving hallway problem#^eqn-monotone]]. The paralleogram $P_\omega$ is the intersection of $H$ and $V_\omega$ ([[10. Notations and conventions/02. Moving sofa#^def-parallelogram]]), and the tangent hallways $L_S(t)$ are the rotating hallways $L_t$ making contact with $S$ as described in the introduction. Condition 3 of [[15. Monotone sofas/07. Tangent Hallway#^thm-moving-sofa-iff-hallway-intersection]] implies that the set $\mathcal{M}(S)$ contains $S$.
