Here, we show that any monotone sofa $S$ is always equal to a _cap_ $K$ minus its _niche_ $\mathcal{N}(K)$ ([[15. Monotone sofas/12. Structure of a monotone sofa#^thm-monotone-sofa-structure]]; see [[01. Introduction/02. Moving hallway problem#^fig-monotone-sofa]]). The key idea is in [[15. Monotone sofas/12. Structure of a monotone sofa#^eqn-monotonization]], which an eager reader may have a look now before reading the details of this section.
...
We postpone the proof of [[15. Monotone sofas/12. Structure of a monotone sofa#^thm-cap-hallway-intersection]] at the end of this section. Define the _niche_ $\mathcal{N}(K)$ associated to any cap $K$.
...
We will always use [[#^thm-monotone-sofa-structure]], the intrinsic variant of [[#^thm-monotonization-structure]], to represent any monotone sofa $S$ as its cap minus niche.
