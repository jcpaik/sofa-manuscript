...
> __Definition [rigid-transformation].__ Here, a _rigid transformation_ on $\mathbb{R}^2$ is the composition $z \mapsto R_t(z) + q$ of translation by vector $q \in \mathbb{R}^2$ and rotation by angle $t \in S^1$ along the origin. ^def-rigid-transformation
...
Assume that a rigid transformation 
