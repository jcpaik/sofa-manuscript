...
Note that $R_t$ is the rotation map in [[10. Notations and conventions/02. Moving sofa#^def-rotation-map]]. The equation of $L_S(t)$ in [[15. Monotone sofas/07. Tangent Hallway#^pro-tangent-hallway]] is motivated by the following defining property of $L_S(t)$.
