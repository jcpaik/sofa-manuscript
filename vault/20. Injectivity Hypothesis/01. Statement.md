...
The variant [[01. Statement#^con-injectivity-cap]] has an advantage that we don't need to prove that the well-behaved cap $K_{\text{max}}$ should be the cap of a monotone sofa. Thus, our upcoming work in focuses on proving [[01. Statement#^con-injectivity-cap]] instead of [[01. Statement#^con-injectivity]], although 