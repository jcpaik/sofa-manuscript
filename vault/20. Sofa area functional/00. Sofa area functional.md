...
Perhaps surprisingly, neither [[00. Sofa area functional#^con-angle-cap]] nor [[00. Sofa area functional#^con-injectivity-cap]] does not necessarily imply the angle and injectivity hypotheses immediately. This is because a maximizer of $\mathcal{A}_\omega$ does not necessarily need to be in the subset $\mathcal{M}_\omega$ of caps of monotone sofas. However, which will be the central focus of subsequent works following this paper.