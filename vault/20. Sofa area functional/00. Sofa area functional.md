...
While we don't prove [[00. Sofa area functional#^con-gerver-cap]], we expect it to be true. We also mention the counterparts of angle and injectivity hypotheses ([[01. Moving Sofa Problem#^con-angle]] and [[01. Moving Sofa Problem#^con-injectivity]]).
...
Perhaps surprisingly, neither [[00. Sofa area functional#^con-angle-cap]] nor [[00. Sofa area functional#^con-injectivity-cap]] does not necessarily imply the angle and injectivity hypotheses respectively. This is because . However, which will be the central focus of a subsequent work that followings.

In this paper, we will prove the following strenghtening of [[01. Moving Sofa Problem#^thm-main]] along the same line of extending the domain from $\mathcal{M}_\omega$ to $\mathcal{K}_\omega$.
...
The goal of the next section is to prove [[00. Sofa area functional#^thm-main-cap]].