...
A caps $K$ with rotation angle $\omega \in (0, \pi/2]$ is defined in [[12. Structure of a monotone sofa#^def-cap]]. Define the space of all such $K$ with a fixed rotation angle $\omega$ as follows.
