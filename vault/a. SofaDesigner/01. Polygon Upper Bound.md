...
> __Definition [cap-space-angled].__ Let $\Theta$ be an angle set with rotation angle $\omega$. A _cap_ $K$ with angle set $\Theta$ is a convex body such that the followings hold. ^def-cap-space-angled
