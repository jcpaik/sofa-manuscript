...
Define $U$ as the following value. Note that the second equality holds by [[b. Upper Bound A1/25. Upper Bound A1/03. Boundary measure#^thm-surface-area-measure-vertex]].
$$
...
$$
The equality holds by [[b. Upper Bound A1/25. Upper Bound A1/03. Boundary measure#^thm-surface-area-measure-vertex]]. Now use [[d. Injectivity Hypothesis/xx. Bounding Arm Lengths (crude, old)#^lem-vertex-approximation]] to bound it from below. □
