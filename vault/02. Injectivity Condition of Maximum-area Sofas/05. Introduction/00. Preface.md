...
[[#^thm-injectivity-abridged]] is an abridged, weaker version of the full main [[02. Injectivity Condition of Maximum-area Sofas/20. Injectivity Condition/00. Preface#^thm-injectivity]] that still captures the essence. The full [[02. Injectivity Condition of Maximum-area Sofas/20. Injectivity Condition/00. Preface#^thm-injectivity]] will be used in the subsequent work. We call the theorem the _injectivity condition_ as it implies that the rotation path $\mathbf{x} : [0, \pi/2] \to \mathbb{R}^2$ of some maximum-area moving sofa have no self-intersection. To see this, observe that
$$
