...
It turns out that the condition (3) of [[02. Injectivity Condition of Maximum-area Sofas/20. Injectivity Condition/01. Statement#^def-injectivity-condition]] is equivalent to stating that $f_K^{\pm}(t) > 1$ and $g_K^{\pm}(t) > 1$. The derivative of $\mathbf{x}_K$ can be expressed in terms of the arm lengths of $K$.
