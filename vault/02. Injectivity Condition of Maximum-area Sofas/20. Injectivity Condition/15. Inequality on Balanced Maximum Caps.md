...
$$
on $t \in (0, \pi/2)$ so $f_K(t)$ is absolutely continuous on $t \in [0, \pi/2]$ (use [[02. Injectivity Condition of Maximum-area Sofas/20. Injectivity Condition/15. Inequality on Balanced Maximum Caps#^pro-cap-nondegenerate-continuity]] to enlarge the domain of continuity). Moreover,
$$
