...
> __Theorem [tangent-line-param-linear].__ For fixed $t \in \mathbb{R}$ and $a, b \in (t - \pi, t]$, the function $\mathbf{l}_K^t|_{[a, b]} : [a, b] \to \mathbb{R}$ is  ^thm-tangent-line-param-linear
