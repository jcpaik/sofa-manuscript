...
> __Lemma [cap-left-right-disjoint].__ For any $K \in \mathcal{K}^\mathrm{i}$, the the sets $K \cap H_K^\mathrm{R}$ and $K \cap H_K^\textrm{L}$ are disjoint. ^lem-cap-left-right-disjoint
