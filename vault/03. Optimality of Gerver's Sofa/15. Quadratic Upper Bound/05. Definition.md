...
In this [[03. Optimality of Gerver's Sofa/15. Quadratic Upper Bound/05. Definition]], we give the full [[03. Optimality of Gerver's Sofa/15. Quadratic Upper Bound/05. Definition#^def-upper-bound-q]] of the upper bound $\mathcal{Q}$ of area.
...
To define $\mathcal{Q}$, we first need to define some constants.
