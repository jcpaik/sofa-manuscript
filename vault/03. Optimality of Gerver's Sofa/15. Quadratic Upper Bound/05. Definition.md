...
$$
\left| \mathcal{N}(K) \setminus H_K^\mathrm{R} \setminus H_K^\mathrm{L} \right|  \geq \mathcal{I}(\mathbf{x}_K|_{[\varphi^\mathrm{R}, \varphi^\mathrm{L}]}) + \mathcal{I}(\mathbf{x}_K^\mathrm{L}, Z_K^\mathrm{L}) + \mathcal{I}(\mathbf{x}_K^\mathrm{R}, W_K^\mathrm{R}).
$$
