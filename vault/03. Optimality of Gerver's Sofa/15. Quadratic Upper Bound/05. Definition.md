...
We enlarge the space of caps $\mathcal{K}^{\mathrm{c}}$ to a larger convex space $\mathcal{L}$, in order to define $\mathcal{Q} : \mathcal{L} \to \mathbb{R}$ as a quadratic functional on $\mathcal{L}$.
