...
$$
\left| \mathcal{N}(K) \setminus H_K^\mathrm{R} \setminus H_K^\mathrm{L} \right|  \geq \mathcal{J}(\mathbf{x}_K|_{[\varphi^\mathrm{R}, \varphi^\mathrm{L}]}) + \mathcal{J}(\mathbf{x}_K^\mathrm{L}, Z_K^\mathrm{L}) + \mathcal{J}(\mathbf{x}_K^\mathrm{R}, W_K^\mathrm{R}).
$$
...
& \leq |K| - \mathcal{J}(\mathbf{x}_K|_{[\varphi^\mathrm{R}, \varphi^\mathrm{L}]}) - \mathcal{J}(\mathbf{x}_K^\mathrm{L}, Z_K^\mathrm{L}) - \mathcal{J}(\mathbf{x}_K^\mathrm{R}, W_K^\mathrm{R}) - \mathcal{J}\left( X_B, W_K^\mathrm{R} \right) + \mathcal{J}\left( \mathbf{r}_B \right) - \mathcal{J}\left( Z_K^\mathrm{L}, Y_D \right) +  \mathcal{J}\left( \mathbf{l}_D \right) \\ 
& = \mathcal{Q}(K, B, D).
\end{align*}
$$
