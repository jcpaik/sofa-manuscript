...
|                                          | $I_1 := [0, \varphi)$ | $I_2 := [\varphi, \theta)$ | $I_3 := [\theta, \pi/2-\theta)$ | $I_4 := [\pi/2 - \theta, \pi/2 - \varphi)$ | $I_5 := [\pi/2 - \varphi, \pi/2)$ | $[0, \varphi]$ | $[\varphi, \theta]$ | $[\theta, \pi/2-\theta]$ | $[\pi/2 - \theta, \pi/2 - \varphi]$ | $[\pi/2 - \varphi, \pi/2]$ |
| ---------------------------------------- | --------------------- | -------------------------- | ------------------------------- | ------------------------------------------ | --------------------------------- | -------------- | ------------------- | ------------------------ | ----------------------------------- | -------------------------- |
