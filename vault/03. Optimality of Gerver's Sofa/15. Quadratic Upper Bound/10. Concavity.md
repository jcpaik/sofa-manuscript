...
_Proof._ Expand all the terms from [[03. Optimality of Gerver's Sofa/05. Notations and Properties/30. Mamikon's Theorem#^def-mamikon]] in the [[03. Optimality of Gerver's Sofa/15. Quadratic Upper Bound/10. Concavity#^def-mamikon-middle]] of $\mathcal{S}_K$. Then $\mathcal{S}_K$ is equal to the large expression below.
$$
\begin{equation*}
\begin{alignedat}{8}
&
...
\end{equation*}
$$
It is easier to verify this by following the bold lines in [[03. Optimality of Gerver's Sofa/15. Quadratic Upper Bound/10. Concavity#^fig-mamikon-sofa]] from right to left. Call the term in $i$'th row and $j$'th column, including the signs, as simply $J_{ij}$. Now check the following calculations.
