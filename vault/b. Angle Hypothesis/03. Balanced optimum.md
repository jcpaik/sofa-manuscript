...
$$
by definition of $K$. That is, $K$ is the intersection of translates of $H$, $R_\omega(H)$ and $R_t(L)$ determined by the coordinates $\mathbf{x}_K : \Theta \to \mathbb{R}^2$. We will make adjustments to 
$$
