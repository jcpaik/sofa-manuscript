...
The extra constants $\sigma_K(3\pi/2), \sigma_K(\omega + \pi), 1$ in [[b. Angle Hypothesis/03. Balanced optimum#^def-polygon-niche-gap]] seems contribed. These are motivated by the following theorem. 
