...
> __Lemma [perturbation-half-plane].__ Let $H_0$ be a closed half-plane with normal angle $t_0 \in S^1$ and boundary $l_0$. Let $X$ be a Nef polygon which is made of finite boolean operations on closed half-planes with 
