...
> 
> - $w_K^\Theta + \mathcal{H}^1\left( \mathcal{N}_\Theta(K) \cap l(\pi/2, 0) \right) \leq \sigma_K( 3\pi/2 )$
> - $z_K^{\Theta} + \mathcal{H}^1\left( \mathcal{N}_\Theta(K) \cap l(\omega, 0) \right) \leq \sigma_K(\omega + \pi)$ 
