...
> __Lemma [area-functional-width-one].__ Let $K$ be the optimizer of $\mathcal{A}(K)$ over all $\mathcal{K}_\omega'$. Then the maximum is attained for $K \in \mathcal{K}_\omega$.
