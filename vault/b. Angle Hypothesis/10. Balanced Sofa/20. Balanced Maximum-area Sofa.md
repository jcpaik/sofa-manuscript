We now take the limit of the balanced polygon sofas in [[b. Angle Hypothesis/10. Balanced Sofa/15. Maximum Polygon Cap#^thm-balanced-polygon-sofa]] to find a monotone sofa $S_\omega$.
...
_Proof._ By [[b. Angle Hypothesis/05. Monotone Sofa/10. Monotone Sofa#^thm-monotonization]] it suffices to show that $S_\omega$ is of largest area among monotone sofas with rotation angle $\omega$. This is true by [[b. Angle Hypothesis/05. Monotone Sofa/20. Sofa Area Functional#^thm-sofa-area-functional]] and [[b. Angle Hypothesis/10. Balanced Sofa/20. Balanced Maximum-area Sofa#^thm-limiting-maximum-cap-max]]. □

We establish the side length comparison in [[b. Angle Hypothesis/10. Balanced Sofa/20. Balanced Maximum-area Sofa#^thm-balanced-maximum-sofa-ineq]], which is a crucial step in the proof of main [[b. Angle Hypothesis/01. Introduction/00. Preface#^thm-angle]].
