...
_Proof._ Immediate from [[b. Angle Hypothesis/05. Monotone Sofa/12. Cap and Niche#^def-niche]]. □
...
> __Remark [mirror-symmetry].__ We use the mirror reflection of a cap in [[b. Angle Hypothesis/05. Monotone Sofa/15. Cap Contains Niche#^def-mirror-reflection]] and [[b. Angle Hypothesis/05. Monotone Sofa/15. Cap Contains Niche#^pro-mirror-reflection]] extensively to exploit the symmetry without loss of generality. For example, say we want to show both $w_K(t) > 0$ and $z_K(t) > 0$ for arbitrary $K \in \mathcal{K}_\omega$ and $t \in (0, \omega)$. Then it suffices to show the case $w_K(t) > 0$, as the symmetric case $z_K(t) = w_{K^{\mathrm{m}}}(\omega - t) > 0$ follows by [[b. Angle Hypothesis/05. Monotone Sofa/15. Cap Contains Niche#^pro-mirror-reflection]]. ^rem-mirror-symmetry

# Cap Contains Niche

We now show that for any monotone sofa $S$, its cap $K$ contains the niche $\mathcal{N}(K)$ ([[b. Angle Hypothesis/05. Monotone Sofa/15. Cap Contains Niche#^thm-niche-in-cap]]). The positivity of $w_K(t)$ and $z_K(t)$ in [[b. Angle Hypothesis/05. Monotone Sofa/15. Cap Contains Niche#^thm-wedge-ends-in-cap]] is important in establishing $\mathcal{N}(K) \subset K$.
...
- If $(0, 0)$ lies strictly below $b_K(t)$ but lies on or above $d_K(t)$, apply the previous case to the mirror reflection $K^{\mathrm{m}}$ and reflect back ([[b. Angle Hypothesis/05. Monotone Sofa/15. Cap Contains Niche#^rem-mirror-symmetry]]).
