...
For reference, the function $\mathcal{A}(K)$ is the _sofa area functional_ on cap $K$ defined in [[b. Upper Bound A1/20. Sofa area functional A/00. Preface#^def-sofa-area-functional]]. $\mathcal{A}_1(K)$ is a conditional upper bound of $\mathcal{A}(K)$ defined in [[b. Upper Bound A1/25. Upper Bound A1/01. Definition of A1#^def-a1]].