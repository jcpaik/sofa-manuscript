We first construct our upper bound 

We now rigorously define the upper bound $\mathcal{A}_1$ and prove its claimed properties. 

Define the _curve area functional_ on an arbitrary rectifiable curve $\mathbf{x}$.
