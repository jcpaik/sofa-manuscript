...
> __Proposition [cap-space-convex-space].__ The space of caps $\mathcal{K}_\Theta$ in is a convex space, equipped with the convex combination $c_\lambda(K_1, K_2) = (1 - \lambda)K_1 + \lambda K_2$. ^pro-cap-space-convex-space
