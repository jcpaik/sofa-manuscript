...
That is, we express $\mathcal{A}_1$ as a linear functional subtracted by a 'sum of squares'. We do this by invoking _Mamikon's theorem_ [[@mnatsakanianAnnularRingsEqual1997]]. The theorem calculates the area of the region swept by tangent segments of a convex body. For the precise statement of Mamikon's theorem that we use for a general planar convex body $K$, refer to [[04. Mamikon's Theorem#^thm-mamikon]].
