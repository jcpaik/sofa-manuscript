...
& = \frac{1}{2} \int_{\omega}^{\pi/2 + \omega} \tau_K(t, \omega + \pi/2)^2 \, dt - \frac{1}{2} p_K(\omega + \pi/2) + \frac{1}{2} h_K^+(\omega)
\end{align*}
$$

Add the two equations together and we get this. ^eqn-a1-yk
$$
\begin{align*}
...
\end{gather}
$$
by [[10. Concavity of A1#^eqn-a1-yk]], and since the terms $h^+_K, \tau_K$, $p_K$ and $\mathcal{I}(\mathbf{y}_K) - \mathcal{I}(\mathbf{x}_K)$ are convex-linear with respect to $K$, $\mathcal{A}_1$ is concave by [[10. Concavity of A1#^lem-sum-of-squares]]. □