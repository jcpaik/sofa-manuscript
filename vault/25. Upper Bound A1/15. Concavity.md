...
\end{gather}
$$
As $h^+_K, \tau_K$, and the last term are convex-linear with respect to $K$, $\mathcal{A}_1$ is negative semidefinite using [[03. Area Functional on Space of Caps#^lem-negative-semidefinite]]. □
