...
& = - \int_{z \in [t, \omega] } (\omega - z) \sin \left( z - t \right) \, dz \\
& = \omega - t - \sin(w - t)
\end{align*}
$$
For the second equality, we use [[10. Surface area measure#^cor-boundary-measure-closed]] with $t_1 = t$ and $t_2 = \omega$. Now use the mirror symmetry to calculate half the area of $K_1$.
$$
\begin{align*}
