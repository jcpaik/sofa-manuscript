...
_Proof._ We have $g_K(t) = g_K^{\pm}(t)$ and $h_K(t) = h_K^{\pm}(t)$ for all $t \in U$ by [[01. Definition of A1#^pro-arm-length-unsigned]]. To calculate the derivatives, first apply [[10. Surface area measure#^thm-boundary-measure]] to [[20. Maximizer of A1#^lem-arm-length-integral]] to get the following equations for all $t \in U$.
$$
