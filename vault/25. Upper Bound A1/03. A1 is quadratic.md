...
The _surface area measure_ $\beta_K$ of $K \in \mathcal{K}_\omega$ will be crucial in establishing [[03. A1 is quadratic#^thm-a1-quadratic]]. Also, we will establish a correspondence between any cap $K \in \mathcal{K}_\omega$ and its surface area measure $\beta_K$ ().
...
[[03. A1 is quadratic#^thm-cap-convex-linear]] in particular establishes that $\mathcal{I}(\mathbf{x}_K)$ is quadratic with respect to $K$.
