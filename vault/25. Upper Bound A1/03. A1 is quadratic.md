...
> __Theorem [a1-quadratic].__ For any $\omega \in (0, \pi/2]$, $\mathcal{A}_1 : \mathcal{K}_{\omega} \to \mathbb{R}$ is  ^thm-a1-quadratic

# Convex-linear values of cap

We remark that a lot of values defined on 
