...
Note that the support function $p_K$ of a convex body $K$ is convex-linear too. By [[03. A1 is quadratic#^thm-surface-area-measure-convex-linear]] and [[03. A1 is quadratic#^thm-surface-area-measure-area]], we have the following.
