...
To prove that $K = K_m$ maximizes a concave quadratic functional $f$ on $\mathcal{K}$, we only need to prove that $Df(K; -)$ is a nonpositive linear functional on $\mathcal{K}$. 
