...
$$
\left. \frac{d}{d \lambda} \right|_{\lambda = 0} f(c_\lambda(K_1, K_2)) = h(K_1, K_2) + h(K_2, K_1) - 2 h (K_1, K_1)
$$
...
_Proof._ For any convex body $K$ we have $|K| = V(K, K)$ where $V$ is the mixed volume of two planar convex bodies. Also note that $V(K_1, K_2) = V(K_2, K_1)$. So by [[15. Calculus of Variation#^lem-quadratic-variation]] □
