...
From [[03. Surface Area Measure#^surface-area-measure-vertex]] with $a = t$ and $b = t + \pi/2$, we have the following.
...
_Proof._ We have the followings for every $t \in U$ by [[20. Maximizer#^lem-arm-length-integral]].
$$
