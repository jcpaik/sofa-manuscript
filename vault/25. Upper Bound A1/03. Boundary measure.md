...
Now the quadradicity of $|K|$ comes from convex-linearity of $p_K$ ([[A1. Convex bodies/05. Vertex and support function#^pro-support-function-linear]]) and $\beta_K$ ([[25. Upper Bound A1/03. Boundary measure#^pro-boundary-measure-linear]]) with respect to $K$.
...
The quadradicity of $\mathcal{A}_1$ is now obtained.
