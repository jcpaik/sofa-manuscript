...
We remark that for the upcoming upper bound $\mathcal{A}_2$, we will choose a more refined version of $\mathbf{z}$ that also includes the small area trimmed at the end of the curve $\mathbf{x}_K$.