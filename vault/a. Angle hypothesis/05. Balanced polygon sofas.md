In this [[a. Angle hypothesis/05. Balanced Polygon Sofas|05. Balanced Polygon Sofas]], our goal is to show that the maximizing polygon cap $K \in \mathcal{K}_\Theta$ of the polygon sofa area $\mathcal{A}_\Theta(K)$ is _balanced_ in the sense of Gerver ([[a. Angle hypothesis/05. Balanced polygon sofas#^thm-balanced-polygon-sofa]]). We postpone its full statement and proof at the end as it involves a lot of technical terms.
