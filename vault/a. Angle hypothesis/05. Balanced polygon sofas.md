...
Second, the cap and niche of a generalized support function $h \in \mathcal{H}_\Theta$ is also well-defined. We only need to follow [[a. Angle hypothesis/05. Balanced polygon sofas#^eqn-cap-support-ftn]] and [[a. Angle hypothesis/05. Balanced polygon sofas#^eqn-niche-support-ftn]].
