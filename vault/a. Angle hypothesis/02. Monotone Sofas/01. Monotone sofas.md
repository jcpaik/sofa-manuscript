In this [[a. Angle hypothesis/02. Monotone Sofas/01. Monotone sofas]], we define the basic notations and the notion of monotone sofas. This follows [Baek] and all notations are compatible with [Baek].
