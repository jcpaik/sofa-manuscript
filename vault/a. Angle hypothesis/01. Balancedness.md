...
Using [[a. Angle hypothesis/01. Balancedness#^def-simple-nef-polygon]], we can spell out the idea used in balancedness condition precisely.
...
The following [[a. Angle hypothesis/01. Balancedness#^lem-nef-polygon-single-edge]] is a special case of [[a. Angle hypothesis/01. Balancedness#^thm-nef-polygon-area-diff]] where we set $\delta_i = 0$ for all index $i$ except for $i=j$.
