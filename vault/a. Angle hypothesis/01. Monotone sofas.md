In this [[a. Angle hypothesis/01. Monotone Sofas]], we define the basic notations and the notion of monotone sofas. This follows [Baek] and all notations are compatible with [Baek].
