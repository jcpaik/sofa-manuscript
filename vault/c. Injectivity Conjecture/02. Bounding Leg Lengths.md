...
Define $U$ as the following value. Note that the second equality holds by [[03. A1 is quadratic#^thm-surface-area-measure-vertex]].
$$
...
$$
The equality holds by [[03. A1 is quadratic#^thm-surface-area-measure-vertex]]. Now use [[02. Bounding Leg Lengths#^lem-vertex-approximation]] to bound it from below.
□
