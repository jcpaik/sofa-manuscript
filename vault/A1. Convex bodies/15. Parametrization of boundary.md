...
By [[A1. Convex bodies/15. Parametrization of boundary#^lem-parametrization-vertex]], the curve $\mathbf{b}_K^{t_0, t_1-}$ ends with the vertex $v_K^-(t_1)$. Moreover, we have the following corollary of [[A1. Convex bodies/15. Parametrization of boundary#^lem-parametrization-vertex]].
