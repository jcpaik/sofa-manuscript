...
Now that $\mathbf{b}_K^{t_0, t_1}$ has no self-intersection is a corollary of [[A1. Convex bodies/15. Parametrization of boundary#^thm-param-concatenation]] and [[A1. Convex bodies/15. Parametrization of boundary#^thm-param-positive-jordan]].
