...
An argument similar to the proof above proves the following symmetric variant [[A1. Convex bodies/05. Vertex and support function#^thm-tangent-line-parametrization]] of [[A1. Convex bodies/05. Vertex and support function#^thm-tangent-line-parametrization]]. We omit the details.
