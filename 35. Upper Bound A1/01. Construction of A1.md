Assuming the [[04. Injectivity Theorem#^thm-injectivity|injectivity theorem]], we manage to find an effective upper bound of the area of the monotone sofa $\mathcal{M}_{[0, \omega]}(K)$. Add that we can assume that maximum sofa can be assumed to be equal to some monotonization of a cap.
