...
> __Theorem [quadratic-functional].__ If $f : \mathcal{K}_\omega \to V$ and $g : \mathcal{K}_\omega \to W$ are convex-linear maps and $h : V \times W \to \mathbb{R}$ is a bilinear form, then $h(f(K), g(K))$ is a quadratic functional on $K \in \mathcal{K}_\omega$. ^thm-quadratic-functional
