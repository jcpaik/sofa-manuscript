...
We stitch the following instances of Mamikon's theorem. First, by [[03. Geometric Results#^thm-mamikon]] on the curve $\mathbf{b}_1$ and $\mathbf{y}(t)$ for $t \in [0, \omega]$ we get the following.
$$
