We define a quadratic functional $\mathcal{A}_1$ on the cap space $\mathcal{K}_\omega$.
...
Assuming the [[04. Injectivity Theorem#^thm-injectivity|injectivity theorem]], $\mathcal{A}_1(K)$ is an upper bound of the area functional $\mathcal{A}(K)$.
