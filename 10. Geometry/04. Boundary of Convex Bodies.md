...
> __Definition [parametrization].__ Let $K$ be any convex body. For any point $p \in \partial K$ there is a continuous curve $\mathbf{x}_{K, p}(t) : [0, B_K] \to \mathbb{R}^2$ is a Jordan curve that  ^def-parametrization
