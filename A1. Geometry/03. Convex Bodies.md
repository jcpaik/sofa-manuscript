...
_Proof._ TODO: reduces to rudimentary epsilon-delta and trigonometry. □

> __Definition [vertex-bounded-variation].__ On any bounded interval $t \in I$ of $\mathbb{R}$, $v_K^+(t)$ is of bounded variation. So $v_K^+(t)$ is locally of bounded-variation. ^def-vertex-bounded-variation
