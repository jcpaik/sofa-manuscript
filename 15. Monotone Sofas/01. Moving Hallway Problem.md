...
- As $S$ is in standard position, $p_S(\omega) = p_S(\pi/2) = 1$ and so [[#^cor-tangent-hallway]] implies that $f_S(0)$ is a horizontal translation of $L$ and $L_S(\omega)$ is a translation of TODO: fill in.
