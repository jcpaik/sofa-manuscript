...
In this way, we maximize the area functional $\mathcal{A} : \mathcal{K}_\omega \to \mathbb{R}$ to find the sofa of maximum area of a sofa that rotates counterclockwise by an angle of $\omega$. This gives an advantage as $\mathcal{K}_\omega$ a convex space, making the optimization of $|S| = |K| - |\mathcal{N}(K)|$ ([[02. Monotone Sofas#^thm-niche-in-cap]]) much easier.
