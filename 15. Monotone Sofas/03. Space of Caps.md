...
We strongly expect that the original area functional $\mathcal{A}$ is not a quadratic functional on $\mathcal{K}_\omega$. But we will construct quadratic functional upper bounds of $\mathcal{A}$ that are much easier to control.
