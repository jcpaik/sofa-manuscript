...
> __Corollary [inner-corner-deriv-exists-almost-everywhere].__ For any cap $K$, $\mathbf{v}_K^+ (t) = \mathbf{v}_K^-(t)$ for all $0 < t < \pi / 2$ except for a countable number of values of $t$. ^cor-inner-corner-deriv-exists-almost-everywhere
...
> __Definition [inner-corner-deriv-almost-everwhere].__ Denote by $\mathbf{v}_K(t)$ the almost-everywhere defined derivative of $\mathbf{x}_K(t)$. ^def-inner-corner-deriv-almost-everwhere