...
> - $K$ is [[02. Notations, Conventions and Results#^def-convex-body-supported|supported by]] the set $\Theta \cup (\Theta + \pi/2) \cup \{\pi + \omega, 3\pi/2\}$.
