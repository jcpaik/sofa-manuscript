...
> __Definition [monotone-sofa].__ A _monotone hallway intersection_ $S$ with cap $K$ and angle set $\Theta$ and rotation angle $\omega$ is the shape $S = \mathcal{M}_\Theta(K)$ that is connected. ^def-monotone-sofa
