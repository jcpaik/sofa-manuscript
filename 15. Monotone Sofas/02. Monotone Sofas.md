By [[01. Moving Hallway Problem#^thm-sofa-iff-hallway-intersection]] we can assume that a maximum sofa is a hallway intersection of angle set $[0, \omega]$ for some $\omega \in [0, \pi/2]$.
