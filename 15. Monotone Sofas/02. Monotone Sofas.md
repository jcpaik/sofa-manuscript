...
The _cap_ $K$ is a convex set which is the parallelogram $P_\omega$ trimmed by the outer walls of $L_S(t)$. The _niche_ $\mathcal{N}(K)$ is the region carved out by the inner corner of $L_S(t)$. To describe this structure in more detail, we first define a _fan_.
