...
For reference, the function \(\mathcal{A}(K)\) is the \emph{sofa area functional} on cap \(K\) in \Cref{def:sofa-area-functional}. \(\mathcal{A}_1(K)\) is a conditional upper bound of \(\mathcal{A}(K)\) in \Cref{def:a1}.