...
> __Definition [hallway].__ The standard _hallway_ $L$ of unit width that rotates 90 degrees is the union $L = L_H \cup L_V$ of its _horizontal side_ $L_H = L \cap H = (-\infty, 1] \times [0, 1]$ and _vertical side_ $L_V = L \cap V = [0, 1] \times (-\infty, 1]$ respectively. ^def-hallway
...
> __Remark [sofa-connected].__ We depend on the connectedness of the sofa throughly in this paper. That is, although there is a possibility of an 'disconnected sofa' abiding to the conditions of [[#^def-sofa]] and having a larger area, we exclude them in our discussion. ^rem-sofa-connected
