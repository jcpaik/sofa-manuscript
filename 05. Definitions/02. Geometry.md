...
> __Definition [fan].__ For any angle $\omega \in [0, \pi/2]$, define the _fan_ $F_\omega$ as the intersection $H(3\pi/2, 0) \cap H(\omega + \pi, 0)$ of half-planes. It's the fan spanned by the ray of positive $x$-axis and the $x$-axis rotated counterclockwise by an angle of $\omega + \pi/2$. Denote its interior as $F_\omega^\circ$. ^def-fan
