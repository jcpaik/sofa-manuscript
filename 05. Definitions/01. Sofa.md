...
We will only consider sofas of rotation angle $\omega \in [\pi/4, \pi/2]$. Indeed, Romik has shown that a sofa of maximum area has rotation angle in . Here we provide a short proof that we can assume $\omega \in [\pi/4, \pi/2]$.
