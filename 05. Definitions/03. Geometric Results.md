...
Mamikon devised a way to calculate the area swept by tangent segments of a curve. Here, we introduce a formalization of his theorem that works for arbitrary convex bodies and rectifiable curves.
